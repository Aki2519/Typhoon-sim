...
class ACEChartDialog(DraggableDialog):
    def __init__(self, sim):
        ...
        self.window_width = int(ACE_CHART_DEFAULT_WIDTH * WINDOW_WIDTH_SCALE)
        self.window_height = ACE_CHART_DEFAULT_HEIGHT
    ...
    def _compute_layout(self):
        ...
        chart2_h = max(360, int(0.4 * tbw * 2 + 14 * 0.8 * tbw))  # 恢复活跃周期图高度
        ...
        self.bg_rect.height = max(self.window_height, total_h)
    ...
    def draw(self, surface: pygame.Surface):
        ...
        self._apply_hint(hint)
        hint = draw_active_periods_chart(surface, self.chart2_rect, cd.active_periods,
                                         cd.year_range, self._typhoon_bar_width)
        self._apply_hint(hint)
