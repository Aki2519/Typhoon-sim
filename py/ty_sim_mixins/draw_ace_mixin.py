...
"""风季 ACE 进度条 / 信息框。"""
import pygame
from ..constants import f_s, f_m, rt, HEMISPHERE_NORTH, INFO_BOX_BG, INFO_BOX_BORDER
...
class TySimDrawACEMixin:
    ...
    def _draw_progress(self, surface, label, cya, right):
        ...
        pygame.draw.rect(surface, WHITE, (x, 30, w, h), 1)
        if cya > 0:
